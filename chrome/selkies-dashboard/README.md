...
Rewired to drive the Jolee Remote hop core (public/viewer.html) via
...
src/jolee-shims/, src/jolee-bridge.js, src/jolee-settings.js, and
src/components/HopControls.jsx are original Jolee additions (not a copy of
selkies-web-core), licensed MPL-2.0 with this dashboard.
